...
# Connect to the Optimism RPC network (replace with your own RPC URL)
optimism_rpc_url = 'YOUR_OPTIMISM_RPC_URL_HERE'  # Replace with your Optimism RPC URL
web3 = Web3(Web3.HTTPProvider(optimism_rpc_url))

# Check connection
if not web3.is_connected():
    print("Failed to connect to the Optimism network")
    exit()
...
def send_transaction(sender_private_key, receiver_address):
    ...
    transaction = {
        ...
        'gas': 21000,  # Gas limit
        'maxFeePerGas': web3.to_wei(0.000450609, 'gwei'),  # Max base fee
        'maxPriorityFeePerGas': web3.to_wei(0.000133394, 'gwei'),  # Priority fee
